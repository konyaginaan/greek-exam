...
function openDict() {
  ...
  const levelEl = document.getElementById('stickyLevel');
  if (titleEl) { titleEl.textContent = d.titleGr; titleEl.style.color = d.accent; }
  if (levelEl) { levelEl.textContent = d.level; levelEl.style.color = d.accent; levelEl.style.borderColor = d.accent; }
...
function closeDict() {
  ...
  if (levelEl) { levelEl.textContent = ''; levelEl.style.borderColor = ''; levelEl.style.color = ''; }
